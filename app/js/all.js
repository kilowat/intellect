...
$(document).ready(function(){$('.gallery .bxslider').bxSlider({pagerCustom:'.gallery .bx-pager',captions:true,});$('.selectize').selectize();$('.selectize-grey').selectize();;(function($,window,document,undefined)
